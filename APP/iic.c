...
uint8_t I2CChkClkRelease(void)
{
	uint16_t TimeoutCnt=1000;				//If Clock is not released within 4ms, is considered overtime
	uint8_t result=0;
...
uint8_t I2CSendData(uint8_t Data, uint8_t ClkFlg)
{
	uint8_t i;
	uint8_t result=0;
...
********************************************************************************/
uint8_t I2CGetData(uint8_t AckFlg)
{
	uint8_t i, RdData=0;
...
Output: CY:1--OK
                  0--Error
********************************************************************************/
uint8_t I2CWrite(uint8_t SlaveID, uint8_t WrAddr, uint8_t Length, uint8_t  *WrBuf)
{
	uint8_t i;
	uint8_t result=0;
	U8 TempBuf[4];
...
Others:
********************************************************************************/
uint8_t I2CRead(uint8_t SlaveID, uint8_t RdAddr, uint8_t Length, uint8_t  *RdBuf)
{
	uint8_t i;
	uint8_t result=0;
